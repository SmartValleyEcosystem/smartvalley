...
namespace SmartValley.Data.SQL.Migrations
{
    ...
    [Migration("20180321071957_AddStaticInformationToProjectScoringApplication")]
    partial class AddStaticInformationToProjectScoringApplication
    {
            ...
            modelBuilder.Entity("SmartValley.Domain.ScoringApplication", b =>
                {
                    ...
                    b.OwnsOne("SmartValley.Domain.ScoringApplication+ScoringApplicationProjectInfo", "ProjectInfo", b1 =>
                        {
                            b1.Property<long?>("ScoringApplicationId");

                            b1.Property<string>("BitcointalkLink")
                            ...
                            b1.Property<string>("WhitePaper")
                                .HasColumnName("WhitePaper");

                            b1.ToTable("ScoringApplications");

                            b1.HasOne("SmartValley.Domain.ScoringApplication")
                                .WithOne("ProjectInfo")
                                .HasForeignKey("SmartValley.Domain.ScoringApplication+ScoringApplicationProjectInfo", "ScoringApplicationId")
                                .OnDelete(DeleteBehavior.Cascade);
                        });
                });
