...
{
    public partial class AddQuestionsForScoringApplications : Migration
    {
...
VALUES(N'UniqueTechnologyDescriptionQuestion', N'', @Id, N'1', N'ProjectGroup', 1, 2, 2)
GO
INSERT[dbo].[ScoringApplicationQuestions]
        ([Key], [ExtendedInfo], [ParentId], [ParentTriggerValue], [GroupKey], [GroupOrder], [Type], [Order])
VALUES(N'FinancialFundsDescriptionQuestion', N'', NULL, NULL, N'ProjectGroup', 1, 2, 3)
GO
declare @Id bigint
...
INSERT[dbo].[ScoringApplicationQuestions]
        ([Key], [ExtendedInfo], [ParentId], [ParentTriggerValue], [GroupKey], [GroupOrder], [Type], [Order])
VALUES(N'LinksToFinancialModelResearchQuestion', N'', @Id, N'1', N'BusinessFinanceGroup', 3, 5, 4)
GO
INSERT[dbo].[ScoringApplicationQuestions]
        ([Key], [ExtendedInfo], [ParentId], [ParentTriggerValue], [GroupKey], [GroupOrder], [Type], [Order])
VALUES(N'CurrentlyAvailableResources', N'{Values: [""OwnedCapitalAnswer"", ""AttractedCapitalAnswer"", ""OwnedAndAttractedCapitalAnswer"", ""HasNoCapitalAnswer""]}', NULL, NULL, N'BusinessFinanceGroup', 3, 2, 5)
GO
INSERT[dbo].[ScoringApplicationQuestions]
        ([Key], [ExtendedInfo], [ParentId], [ParentTriggerValue], [GroupKey], [GroupOrder], [Type], [Order])
...
INSERT[dbo].[ScoringApplicationQuestions]
        ([Key], [ExtendedInfo], [ParentId], [ParentTriggerValue], [GroupKey], [GroupOrder], [Type], [Order])
VALUES(N'DoYouHaveRealUsersQuestion', N'', NULL, NULL, N'MarketingGroup', 9, 1, 12)
...
INSERT[dbo].[ScoringApplicationQuestions]
        ([Key], [ExtendedInfo], [ParentId], [ParentTriggerValue], [GroupKey], [GroupOrder], [Type], [Order])
VALUES(N'LegalOpinionLinkQuestion', N'', 93, N'1', N'LegalGroup', 10, 5, 4)
GO
declare @Id bigint
