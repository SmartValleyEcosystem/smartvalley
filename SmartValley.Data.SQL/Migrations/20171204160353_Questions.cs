    ...
    public partial class Questions : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(@"INSERT INTO Questions (Name, Description, ExpertiseArea, MinScore, MaxScore, QuestionIndex)
                                    ...
                                    ('Blockchain use effectiveness', 'Blockchain is required - <strong>5</strong> points<br/>Blockchain solves minor problems - <strong>2</strong> points<br/>Blockchain is not required - <strong>0</strong> points<br/><br/>Minimum: <strong>0</strong> points, Maximum: <strong>5</strong> points', 3, 0, 7,0),
