...
export function multiTranslateLoaderFactory() {
  return new MultiTranslateLoader([
    ...
    'components/common/delete-allotment-event-modal/delete-allotment-event-modal.component',
    ...
    'components/common/receive-tokens-modal/receive-tokens-modal.component',
